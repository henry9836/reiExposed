...
public class EnemySeekWander : StateMachineBehaviour
{
    GameObject enemy;
    EnemyController ec;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        //Have we arrived
        if ((ec.target - enemy.transform.position).sqrMagnitude <= (ec.arriveDistanceThreshold * ec.arriveDistanceThreshold))
        {
